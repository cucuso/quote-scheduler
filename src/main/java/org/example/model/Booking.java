...
public class Booking {
    ...
    public String getPickupAccess() {
        return pickupAccess;
    }

    public void setPickupAccess(String pickupAccess) {
        this.pickupAccess = pickupAccess;
    }
    ...
    public void setTentativeTime(String tentativeTime) {
